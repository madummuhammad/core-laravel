            ...
            <div class="page-header-content pt-4">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto mt-4">
                        ...
                        <div class="page-header-subtitle text-success">List Surat Undangan</div>
                    </div>
                </div>
            ...
            <div class="col-lg-12">
                <div class="card card-header-actions mb-4">
                    <div class="card-header text-success">
                        List Surat Undangan
                        <a class="btn btn-sm btn-success" href="{{ route('undangan.create') }}">
...
<script>
    ...
    { data: 'isi_undangan', name: 'isi_undangan' },
