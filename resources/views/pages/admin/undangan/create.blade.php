                ...
                <div class="col-lg-9">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                <label for="perihal" class="col-sm-3 col-form-label">Nomor Perihal</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('perihal') is-invalid @enderror" value="{{ old('perihal') }}" name="perihal" placeholder="Nomor Perihal.." required>
                                </div>
                                @error('perihal')
                                <div class="invalid-feedback">
                                    {{ $message; }}
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" class="form-control @error('file_undangan') is-invalid @enderror" value="{{ old('file_undangan') }}" accept=".pdf" name="file_undangan" required>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="isi_undangan" class="form-control @error('isi_undangan') is-invalid @enderror" cols="30" rows="10" required></textarea>
                                </div>
                                @error('isi_undangan')
                                <div class="invalid-feedback">
                                    {{ $message; }}
